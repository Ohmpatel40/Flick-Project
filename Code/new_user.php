    ...
    <body>
        <div class="whos_watching">
            ...
            <div class="new_center_div">
                <h1 class="new_user_head"> Add Profile</h1>
                ...
                <h6 class="select_icon"> Enter Name</h6> 
                    <input type="text" class="new_user_name" placeholder="Enter Name" name="name" autocomplete="off" required/>
                    <input type="submit" class="new_user_btn" name="add_user" value="Add Profile" />
                </form>
            </div>
        </div>
        <?php
