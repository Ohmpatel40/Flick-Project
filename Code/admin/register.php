                        ...
                        <div class="p-5">
                            ...
                            <form method="POST" class="user">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-6">
                                        <input type="password" class="form-control form-control-user"
                                            id="exampleRepeatPassword" placeholder="Repeat Password" name="cpassword" autocomplete="off" required>
                                    </div>
                                </div>
                                <button type="submit" href="index.php" name="submit" class="btn btn-primary btn-user btn-block">
                                    Register Account
                                </button>
                            </form>
                            <hr>
